...
/**
 * @ORM\Entity(repositoryClass="App\Repository\EstadoLibroRepository")
 */
class EstadoLibro
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Ejemplar", mappedBy="estadoLibro")
     */
    private $ejemplars;
    ...
    public function removeEjemplar(Ejemplar $ejemplar): self
    {
        if ($this->ejemplars->contains($ejemplar)) {
            ...
            if ($ejemplar->getEstadoLibro() === $this) {
                $ejemplar->setEstadoLibro(null);
            }
        }
